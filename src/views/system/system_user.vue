            ...
            <div class="app-container">
                <div class="box">
                    ...
                    <el-table size="small" current-row-key="id" :data="dataList" stripe highlight-current-row>
                        ...
                        <el-table-column prop="date" label="生日" align="center"></el-table-column>
                        ...
                        <el-dialog title="新增用户" :visible.sync="dialogFormVisible">
                            <template>
                                <el-tabs v-model="activeName" type="card">
                                    ...
                                    <el-tab-pane label="角色组信息" name="second">
  ...
  created() {    
            ...
            methods: {
                ...
                handleCreate() {
                    ...
                    this.$http.get("api/user/findAllRole").then(res=>{
                        if(res.data.flag) {
                ...
                handleDelete(row) {
                    this.$confirm('您确定要删除吗？','提示',{
                                ...
                                this.$http.delete("api/user/deleteUserById/" + row.id).then((res)=>{
                                    if(res.data.flag) {
                                        this.pagination.currentPage=1;
                                        this.findPage();
                                    } else {
                ...
                handleUpdate(row){
                    ...
                    this.$http.post("api/user/findRoleInfoById/" + row.id).then(res=>{
                        if(res.data.flag){
